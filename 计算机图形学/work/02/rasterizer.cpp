...
void rst::rasterizer::rasterize_triangle(const Triangle& t) {
    ...
    // auto v = t.toVector4();
    // int x_top = std::max(t.tex_coords[0][0],std::max(t.tex_coords[1][0],t.tex_coords[2][0]));
    // int x_down = std::min(t.tex_coords[0][0],std::min(t.tex_coords[1][0],t.tex_coords[2][0]));
    // int y_top = std::max(t.tex_coords[0][0],std::max(t.tex_coords[1][0],t.tex_coords[2][0]));
    // int y_down = std::min(t.tex_coords[0][1],std::min(t.tex_coords[1][1],t.tex_coords[2][1]));

  
    // for(int x = x_down; x < x_top; x++)
    // {
